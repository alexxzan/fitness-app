<template>
  <ion-card :button="button" class="exercise-card" @click="$emit('click', exercise)">
    <!-- Thumbnail Image -->
    <div v-if="showThumbnail && exercise.gifUrl" class="exercise-thumbnail-container">
      <ion-img
        :src="exercise.gifUrl"
        :alt="exercise.name"
        loading="lazy"
      ...
      <div v-if="canAddToWorkout" class="add-button-overlay" @click.stop="handleAddToWorkout">
        <ion-button
          fill="solid"
          size="small"
          color="primary"
